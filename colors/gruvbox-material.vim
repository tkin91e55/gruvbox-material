...
if s:configuration.enable_italic
  call gruvbox_material#highlight('RedItalic', s:palette.red, s:palette.none, 'bold')
  call gruvbox_material#highlight('OrangeItalic', s:palette.orange, s:palette.none, 'bold')
  call gruvbox_material#highlight('YellowItalic', s:palette.yellow, s:palette.none, 'bold')
  call gruvbox_material#highlight('GreenItalic', s:palette.green, s:palette.none, 'bold')
  call gruvbox_material#highlight('AquaItalic', s:palette.aqua, s:palette.none, 'bold')
  call gruvbox_material#highlight('BlueItalic', s:palette.blue, s:palette.none, 'bold')
...
" nvim-treesitter/nvim-treesitter {{{
if has('nvim-0.8')
  highlight @markup.heading.1.markdown cterm=bold ctermfg=208 gui=italic,bold guifg=#fe1919
  highlight @markup.heading.2.markdown cterm=bold ctermfg=208 gui=italic,bold guifg=#fd9d49
  highlight @markup.heading.3.markdown cterm=bold ctermfg=11  gui=italic,bold guifg=#fcb36d
  highlight @markup.heading.4.markdown cterm=bold ctermfg=223 gui=italic,bold guifg=#fbe28f
  highlight @markup.heading.5.markdown cterm=bold ctermfg=230 gui=italic,bold guifg=#f7fab3
  highlight @markup.heading.6.markdown cterm=bold ctermfg=255 gui=italic,bold guifg=#e3f9d7
  " for suse nvim 0.10
